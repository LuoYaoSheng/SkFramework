...
- (void)aop_viewDidLoad {
    ...
    if ([self isKindOfClass:[UINavigationController class]]) {
        ...
        nav.navigationBar.barTintColor = SK_COLOR_BARTINT;
...
- (void)skBasePushNotification:(NSNotification *)notify
{
    ...
    NSString *animate = [NSString stringWithFormat:@"%@", [info objectForKey:@"animate"] ];
    BOOL isAnimate = ![animate isEqualToString:@"NO"];
